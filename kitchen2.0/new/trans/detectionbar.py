...
def model_detection(img):
    ...
    img=cv2.rectangle(img,(335,345),(335+70,345+40),(0,255,255),1)
    ...
    img=cv2.rectangle(img,(410,410),(410+145,410+100),(0,255,255),1)
    ...
    img=cv2.rectangle(img,(526,326),(526+60+40,326+30),(0,255,255),1)
